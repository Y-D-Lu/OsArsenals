...
declare namespace photoAccessHelper {
    ...
    */
    ...
    enum PhotoKeys {
        ...
        /**
         * Supported watermark type (hidden system API)
         *
         * @syscap SystemCapability.FileManagement.PhotoAccessHelper.Core
         * @hidden
         * @since 10
    ...
    /**
     * Enumeration of watermark type (hidden system API)
     *
    ...
    class MediaAssetChangeRequest implements MediaChangeRequest {
        ...
        /**
         * Sets the supported watermark type (hidden system API)
         *
